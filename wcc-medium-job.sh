...
#PBS -o wcc-medium-job.output
#PBS -e wcc-medium-job.error
...
#  run_single_dataset_wcc ${CUDA_AWARE_MPI} ${METHOD} "data/web-Stanford.bin" ${MPICH_GPU_SUPPORT_ENABLED}
  ...
  run_single_dataset_wcc ${CUDA_AWARE_MPI} ${METHOD} "data/large_datasets/twitter_rv.bin" ${MPICH_GPU_SUPPORT_ENABLED}
  ...
  echo "--------------------------------- TC ---------------------------------"
  run_single_dataset_tc ${CUDA_AWARE_MPI} ${METHOD} "data/large_datasets/wb-edu.bin" ${MPICH_GPU_SUPPORT_ENABLED}
  run_single_dataset_tc ${CUDA_AWARE_MPI} ${METHOD} "data/large_datasets/wiki-topcats.bin" ${MPICH_GPU_SUPPORT_ENABLED}
  run_single_dataset_tc ${CUDA_AWARE_MPI} ${METHOD} "data/large_datasets/ML_Geer.bin" ${MPICH_GPU_SUPPORT_ENABLED}
  ...
  run_single_dataset_sg ${CUDA_AWARE_MPI} ${METHOD} "data/large_datasets/wb-edu.bin" ${MPICH_GPU_SUPPORT_ENABLED}
  run_single_dataset_sg ${CUDA_AWARE_MPI} ${METHOD} "data/large_datasets/wiki-topcats.bin" ${MPICH_GPU_SUPPORT_ENABLED}
  run_single_dataset_sg ${CUDA_AWARE_MPI} ${METHOD} "data/large_datasets/ML_Geer.bin" ${MPICH_GPU_SUPPORT_ENABLED}
