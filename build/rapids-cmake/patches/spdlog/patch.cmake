...
function(rapids_cpm_run_git_patch file issue)
  ...
  if(result EQUAL 0)
    list(APPEND msg_state "rapids-cmake [spdlog]: applied ${ext} ${file_name} to fix issue: '${issue}'")
  else()
    list(APPEND msg_state "rapids-cmake [spdlog]: failed to apply ${ext} ${file_name}")
    list(APPEND msg_state "rapids-cmake [spdlog]: git ${ext} output: ${repo_error_info}")
  endif()
...
set(files "/mnt/9054B61D54B605CE/GithubCodes/mnmgJOIN/build/_deps/rapids-cmake-src/rapids-cmake/cpm/patches/spdlog/nvcc_constexpr_fix.diff")
set(issues "Fix constexpr mismatch between spdlog and fmt [https://github.com/gabime/spdlog/issues/2856]")
set(output_file "/mnt/9054B61D54B605CE/GithubCodes/mnmgJOIN/build/rapids-cmake/patches/spdlog/log")
