...
#PBS -o wcc-merged-small2.output
#PBS -e wcc-merged-small2.error
...
run_benchmark() {
  ...
  run_single_dataset ${CUDA_AWARE_MPI} ${METHOD} "data/web-Stanford.bin" ${MPICH_GPU_SUPPORT_ENABLED}
  run_single_dataset ${CUDA_AWARE_MPI} ${METHOD} "data/WikiTalk.bin" ${MPICH_GPU_SUPPORT_ENABLED}
  run_single_dataset ${CUDA_AWARE_MPI} ${METHOD} "data/web-Google.bin" ${MPICH_GPU_SUPPORT_ENABLED}
  run_single_dataset ${CUDA_AWARE_MPI} ${METHOD} "data/arabic-2005.bin" ${MPICH_GPU_SUPPORT_ENABLED}
